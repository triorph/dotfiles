...
vim.api.nvim_set_keymap("n", "<leader>fa", "<cmd>DashboardFindWord<cr>",
  {silent = true, noremap = true}
)
vim.api.nvim_set_keymap("n", "<leader>fb", "<cmd>DashboardJumpMark<cr>",
  {silent = true, noremap = true}
)
vim.api.nvim_set_keymap("n", "<leader>cn", "<cmd>DashboardNewFile<cr>",
  {silent = true, noremap = true}
)
