...
private const val nextColourRgbTemplate =
...
private const val nextColourIndexTemplate =
...
private fun rgb(red: Int, green: Int, blue: Int): List<Int> = listOf(red, green, blue)
