# Generated by Powerlevel10k configuration wizard on 2021-12-13 at 08:34 NZDT.
...
## The below jujutsu prompt segment comes from
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      (( $#branch > 32 )) && branch[23,-3]="…"  # <-- this line
